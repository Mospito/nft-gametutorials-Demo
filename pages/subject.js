        ...
        <Layout>
            ...
            <div className='flex flex-row justify-center w-full items-center'>
                <div className='flex flex-col justify-start items-center text-4xl w-2/5 p-4 mr-6 font-bold uppercase tracking-wider shadow-xl bg-redcony rounded-lg'>
                    ...
                    <a className='flex justify-center mt-4 text-2xl font-bold  animate-pulse'>" เลือกวิชาเรียนที่สนใจได้เลยครับ "</a>
                </div>
                <div className='-ml-20'>
            ...
            <div className='md:flex flex-row fixed justify-start items-start pl-20 pt-20  h-screen w-screen'>
                <Link href='/lesson'>
                    <a className='flex flex-col w-56 h-28 bg-sunglow shadow-2xl rounded-xl transition duration-700 
